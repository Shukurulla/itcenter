      ...
      <div className="col-lg-5 col-md-12">
        <div className="retseption-box">
          ...
          <div className="contact-us">
            <h3>Contact Us</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti labore magnam perspiciatis temporibus aliquid ducimus at optio expedita totam rerum!</p>
          </div>
          <div>
